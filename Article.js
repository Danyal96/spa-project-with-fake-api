          ...
          <Col lg={4}>
            <div className="articlecardcontainer">
              ...
              <div className="cardbody">
                ...
                <p>
                    <BiCategoryAlt />
                      دستع بندی : <b>  {articleData.category} </b>
                </p>
              </div>
              <div className="cardfooter">
                <Button onClick={()=>deleteArticleHandler(articleId)} variant="outline-danger"><MdDelete />حذف مقاله</Button>
                <Link to={`/edit-article/${articleId}`}><Button variant="outline-primary"><MdOutlineEditCalendar />ویرایش مقاله</Button></Link>
              </div>
            </div>
          </Col>
